      ...
      <Transition.Root>
        ...
        >
          ...
          >
            ...
            <MobileNavLink href="https://docs.cinchprotocol.io/cinch-protocol-documentation/">Doc</MobileNavLink>
        ...
        <nav className="relative z-50 flex justify-between">
          ...
          <div className="flex items-center gap-x-5 md:gap-x-8">
            <div className="hidden md:flex md:gap-x-6">
              ...
              <NavLink href="https://docs.cinchprotocol.io/cinch-protocol-documentation/">Doc</NavLink>
            </div>
