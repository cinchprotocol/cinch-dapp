    ...
    <Container className="pt-20 pb-16 text-center lg:pt-32">
      ...
      <p className="mx-auto max-w-4xl font-display text-5xl font-medium tracking-tight text-slate-900 sm:text-7xl">
        <span className="relative whitespace-nowrap text-blue-600 text-center">
          ...
          <span className="relative">Grow TVL and reduce native token emissions</span>
        </span>{" "}
      </p>
      <p className="mx-auto mt-6 max-w-2xl text-lg tracking-tight text-slate-700">
      We took the “ve” money legos and turned it into a powerful growth tool. Leverage the token playbook without incurring native token dilution or sell pressure.
      </p>
